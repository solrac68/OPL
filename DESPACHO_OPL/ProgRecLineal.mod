...
dvar float+ B_OnOff_Rec[Rec_Hidraulico union Rec_Solar union Rec_Eolico][Periodos];	/*On Off de los recursos a excepción de los térmicos, si este se enciende el resultado debe ser 1*/
dvar float+ B_OnOff_RecT[Rec_Termicos][Periodos];						/*On Off del recurso térmico, si este se enciende el resultado debe ser 1*/
dvar float+ B_RampaUR[Rec_Termicos][Periodos];						/*Si en un periodo existe generación V_GenRampaUR para un recurso en un periodo*/
dvar float+ B_RampaDR[Rec_Termicos][Periodos];						/*Si en un periodo existe generación V_GenRampaDR para un recurso en un periodo*/
//dvar float+ B_Arranque[Rec_Termicos][Periodos];							/*Arranque del recurso térmico, si este arranca en el periodo t el resultado debe ser 1.  Se toma respecto la generación en firme*/
...
dvar float+ B_Parada[Rec_Termicos][Periodos];							/*Parada del recurso térmico, si este para en el periodo t el resultado debe ser 1. Se toma respecto la generación en firme*/
//dvar float+ B_Arr_Caliente[Rec_Termicos][Periodos];					/*Arranque en caliente del recurso térmico, si está en estado caliente el valor del arranque debe ser 1*/	
...
dvar float+ B_Arr_Tibio[Rec_Termicos][Periodos];						/*Arranque en Tibio del recurso térmico, si está en estado caliente el valor del arranque debe ser 1*/	
dvar float+ B_Arr_Frio[Rec_Termicos][Periodos];						/*Arranque en Frio del recurso térmico, si está en estado caliente el valor del arranque debe ser 1*/
dvar float+ B_Ufact[BloquesFactibles][Periodos];						/*Indica que intervalo factible se activó en cada periodo para los recursos con zonas infactibles*/
dvar float+ B_uFact_min[RecInfact_Esp][Periodos];						/*Indica si la generación del recurso térmico con zona infactible especial está en el intervalo mínimo factible */
dvar float+ B_uInfact[RecInfact_Esp][Periodos];						/*Indica si la generación del recurso térmico con zona infactible especial está en el intervalo infactible */
dvar float+ B_uFact_max[RecInfact_Esp][Periodos];						/*Indica si la generación del recurso térmico con zona infactible especial está en el intervalo máximo factible*/
//dvar float+ B_Par_Normal[Rec_Termicos][Periodos];						/*Indica si la parada del recurso se da por la salida de bloques normal*/
...
dvar float+ B_Par_Especial[Rec_Termicos][Periodos];						/*Indica si la parada del recurso se da por la salida de bloque especial*/
dvar float+ B_UR[Interv_UR][Periodos];								/*Indica si el intervalo del modelo 2 para subir (UR) se activa o no*/	
dvar float+ B_DR[Interv_DR][Periodos];								/*Indica si el intervalo del modelo 2 para bajar (DR) se activa o no*/
dvar float+ B_DR_Prima[RT_DRPrima][Periodos];							/*Indica si aplica o no el despacho alternativo de bajada  entre la generación del periodo t-1 y t*/
dvar float+ B_UR_Prima[RT_URPrima][Periodos];							/*Indica si aplica o no el despacho alternativo de subida  entre la generación del periodo t-1 y t*/
dvar float+ B_uDisp[RT_DRPrima][Periodos];							/*Indica si la generación del recurso se encuentra en la disponibilidad*/
dvar float+ B_uMinT[RT_URPrima][Periodos];							/*Indica si la generación del recurso se encuentra en el mínimo técnico*/
dvar float+ B_bCE[RT_ModCE][Periodos];								/*Indica si la diferencia de la generación entre dos periodos supera el máximo valor para CE*/		
dvar float+ B_RHUR[IntervRH_UR][Periodos];							/*Indica si el intervalo del modelo 2 para subir (UR) se activa o no. Rec. Hidráulicos*/	
dvar float+ B_RHDR[IntervRH_DR][Periodos];							/*Indica si el intervalo del modelo 2 para bajar (DR) se activa o no. Rec. Hidráulicos*/	
dvar float+ B_OnOff_Und[Und_Hidraulica union Und_Solar union Und_Eolica][Periodos];		/*On Off de la unidad, si este se enciende el resultado debe ser 1 (No aplica para unidades térmicas)*/	
dvar float+ B_OnOff_UMenor[Und_noCentral][Periodos];						/*On Off de la unidad no despachada centralmente, si este se enciende el resultado debe ser 1*/	
dvar float+ B_OnOff_UndT[Und_Termica][Periodos];						/*On Off de la unidad térmica, si este se enciende el resultado debe ser 1*/
dvar float+ B_MC_On[Rec_Termicos][Periodos];							/*Variable binaria que indica que el recurso tiene una generación mayo que cero*/
//dvar float+ B_MC_Arr[Rec_Termicos][Periodos];						/*Variable binaria que indica que el recurso arrancó con referencia a una generación mayor que cero*/
...
dvar float+ B_MC_Par[Rec_Termicos][Periodos];							/*Variable binaria que indica que el recurso paró con referencia a una generación mayor que cero*/
//dvar float+ B_MC_Arr_Caliente[Rec_Termicos][Periodos];					/*Arranque Caliente del recurso respeco la generación Mayor que cero*/			
...
dvar float+ B_MC_Arr_Tibio[Rec_Termicos][Periodos];						/*Arranque Tibio del recurso respeco la generación Mayor que cero*/
dvar float+ B_MC_Arr_Frio[Rec_Termicos][Periodos];						/*Arranque Frio del recurso respeco la generación Mayor que cero*/
/*|___________________________________________________________________________________________________________________________________________________________________________________________________________|*/
